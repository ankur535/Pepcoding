...
public class TransformToLeftClonedTree {
	...
	//This code with void can also be used
	public static void createLeftCloneTree2(Node root) {
		// write your code here
		if (root == null) {
			return;
		}
		//faith
		createLeftCloneTree2(root.left);
		createLeftCloneTree2(root.right);
	...
	//Without return also works as above
