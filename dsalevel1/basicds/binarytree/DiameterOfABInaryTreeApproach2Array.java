...
public class DiameterOfABInaryTreeApproach2Array {
	...
	public static int diameter(Node node, int arr[]) {
		...
		// find diameter there itself on last node and put in array
		int dia = lh + rh + 2;
		arr[0] = Math.max(arr[0], dia);
