...
public class NodeWithMaximumSubtreeSumApproach2 {
	...
	/**
	 	This is Approach 2 : Bottom Up Approach
	 	Here we are using global variable to store max Node and max Sum
	...
	public static int getNodeWithMaxSubtreeSum (Node root) {
		...
		for (Node child: root.children) {
			...
			sum += getNodeWithMaxSubtreeSum(child);	
		}
